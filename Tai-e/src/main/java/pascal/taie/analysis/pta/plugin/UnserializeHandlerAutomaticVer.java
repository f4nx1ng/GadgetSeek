...
public class UnserializeHandlerAutomaticVer implements Plugin{
    ...
    public void onPhaseFinish(){
        ...
        solver.getCallGraph().reachableMethods().forEach(csMethod -> {
            ...
            if (thisVar != null && context != null && hasTainted(thisVar, context) && judgeClass(csMethod.getMethod().getDeclaringClass())){
                ...
                JMethod readObject = csMethod.getMethod().getDeclaringClass().getDeclaredMethod("readObject");
